...
func (ui_scroll *UI_Scrollpane) Init(idLabels []string, backend *UI_Backend, style *UI_Object_Style, Position, Dimensions coords.CoordInts) error {
	...
	ui_scroll.Image = ebiten.NewImage(Dimensions.X-modified, Dimensions.Y)
	...
	ui_scroll.Scrollbar_Horizontal.Init([]string{"scrollbar_vertical", "X"}, backend, style, coords.CoordInts{X: 0, Y: Dimensions.Y - int(ui_scroll.scrollbar_width)}, coords.CoordInts{X: Dimensions.X - int(ui_scroll.scrollbar_width), Y: int(ui_scroll.scrollbar_width)})
...
/**/
func (ui_scroll *UI_Scrollpane) GetNumber_Children() int { return 0 }

/**/
func (ui_scroll *UI_Scrollpane) GetChild(index int) UI_Object { return nil }

/**/
func (ui_scroll *UI_Scrollpane) AddChild(child UI_Object) error { return nil }
